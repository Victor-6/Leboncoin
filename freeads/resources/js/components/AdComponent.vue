            ...
            <div class="card-body">
                <form id="formAd" method="POST" :action="url">
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select" name="category" id="category" @change="onCategoryChange()"
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select" name="region" id="region" @change="onRegionChange()"
                    ...
                    <div v-if="regionSelected != 0" class="form-group">
                        ...
                        <select class="custom-select" name="departement" id="departement" @change="onDepartementChange"
                    ...
                    <div v-if="departementSelected != 0" class="form-group">
                        ...
                        <select class="custom-select" name="commune" id="commune" @change="onCommuneChange"
...
<script>
    ...
    export default {
        ...
        methods: {
            onCategoryChange() { //Si c’est un changement de catégorie on se contente d’envoyer la requête de recherche
                this.submit();
            },
            onRegionChange() { //Si c’est un changement de région c’est plus complexe, en effet il faut alors actualiser la liste des départements
            ...
            fillDepartements(code) { //Pour remplir la liste des département on fait appel à l’API comme on l’a vue pour les factories :
                if (code) {
                    let that = this;
            ...
            submit(e, comp = '') { // changement de département avec la liste des communes.
                $.ajax({
                    method: 'post',
                    url: this.url + comp,
                    data: {
