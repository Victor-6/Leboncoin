    ...
    <div class="container">
        ...
        <div class="card bg-light">
                    ...
                    <div id="ctrl" class="carousel slide" data-ride="carousel">
                        <ol class="carousel-indicators">
                            @foreach ($photos as $photo)
                                <li data-target="#ctrl" data-slide-to="{{ $loop->index }}"
                        ...
                        <div class="carousel-inner">
                            @foreach ($photos as $photo)
                                <div class="carousel-item @if($loop->first) active @endif">
                                    <img class="d-block w-100" src="{{ asset('images/' . $photo->filename) }}"
                                         alt="First slide">
                                </div>
                            @endforeach
                        </div>
            ...
            <div class="card-body">
                ...
                <hr>
                <p class="card-text"><u>Prix</u> : {{ $ad->price }}</p>
                ...
                <a class="btn btn-primary" href="{{ route('annonces.create') }}" role="button">Modifier votre
                    annonce</a>
            </div>
        </div>
    </div>
